...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header" >
                ...
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href=""></a> Marketing</li>
                    </ol>
                </div>
            ...
            <!-- Row -->
             <form method = "" enctype="multipart/form-data" data-parsley-validate="" action="">
                                ...
                                <div class=" row mb-4">
                                    ...
                                    <select required name="kyc" value="{{ old('kyc') }}" class="form-control select2" required>
                                        ...
                                        <option value="" disabled>-Choose-</option>
                                            <option disabled value="Pending" {{ $data->kyc == 'Pending' ? 'selected' : '' }}>Pending
                                            </option>
                                            <option disabled value="Completed" {{ $data->kyc == 'Completed' ? 'selected' : '' }}>Completed
                                            </option>
