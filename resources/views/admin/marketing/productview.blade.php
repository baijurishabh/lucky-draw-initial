                            ...
                            <div class="card-body">
                                <div class=" card-body">
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input type="text" name="name" disabled value="{{ old('name') }}"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="text" name="short_description"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                            <textarea name="description" required disabled class=" ckeditor form-control" id="">{{ old('description') }}</textarea>
                                            @else
                                            <textarea disabled name="description" disabled class=" ckeditor form-control" required id="">{{ isset($data->description) ? $data->description : '' }}</textarea>
                                            @endif
                                        </div>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                            <textarea disabled name="specification" required class=" ckeditor form-control" id="">{{ old('specification') }}</textarea>
                                            @else
                                            <textarea disabled name="specification" class=" ckeditor form-control" required id="">{{ isset($data->specification) ? $data->specification : '' }}</textarea>
                                            @endif
                                        </div>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="text" name="market_price" value="{{ old('market_price') }}"
                                                    class="form-control" required>
                                            @else
                                                <input disabled type="number" required name="market_price"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="text" name="our_price" value="{{ old('our_price') }}"
                                                    class="form-control" required>
                                            @else
                                                <input disabled type="number" required name="our_price"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="text" name="online_price" value="{{ old('online_price') }}"
                                                    class="form-control" required>
                                            @else
                                                <input disabled type="number" required name="online_price"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="text" name="quantity" value="{{ old('quantity') }}"
                                                    class="form-control" required>
                                            @else
                                                <input disabled type="number" required name="quantity"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <div class="col-md-9">
                                            @if (empty($data))
                                                <input disabled type="url" name="youtube_link" value="{{ old('youtube_link') }}"
                                                    class="form-control" required>
                                            @else
                                                <input disabled type="url" required name="youtube_link"
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select required name="category_id" value="{{ old('category_id') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="{{ $item->id }}" value="{{$item->id}}" {{ old('category_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                            @else
                                            <option disabled selected disabled value="">Select</option>
                                            @foreach (App\Models\Category::all() as $item)
                                                <option disabled value="{{ $item->id }}" {{ $data->category_id == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                            @endforeach
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select name="active" value="{{ old('card_status') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="">-Choose-</option>
                                            @if (empty($data))
                                                <option disabled value="YES" {{ old('active') == 'YES' ? 'selected' : '' }}>YES</option>
                                            <option disabled value="NO" {{ old('') == 'NO' ? 'selected' : '' }}>NO</option>
                                            @else
                                                <option disabled value="YES" {{ $data->active == 'YES' ? 'selected' : '' }}>YES
                                                </option>
                                                <option disabled value="NO" {{ $data->active == 'NO' ? 'selected' : '' }}>NO
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select name="special_deal" value="{{ old('special_deal') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="">-Choose-</option>
                                            @if (empty($data))
                                                <option disabled value="YES" {{ old('special_deal') == 'YES' ? 'selected' : '' }}>YES</option>
                                            <option disabled value="NO" {{ old('') == 'NO' ? 'selected' : '' }}>NO</option>
                                            @else
                                                <option disabled value="YES" {{ $data->special_deal == 'YES' ? 'selected' : '' }}>YES
                                                </option>
                                                <option disabled value="NO" {{ $data->special_deal == 'NO' ? 'selected' : '' }}>NO
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select name="popular" value="{{ old('popular') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="">-Choose-</option>
                                            @if (empty($data))
                                                <option disabled value="YES" {{ old('popular') == 'YES' ? 'selected' : '' }}>YES</option>
                                            <option disabled value="NO" {{ old('') == 'NO' ? 'selected' : '' }}>NO</option>
                                            @else
                                                <option disabled value="YES" {{ $data->popular == 'YES' ? 'selected' : '' }}>YES
                                                </option>
                                                <option disabled value="NO" {{ $data->popular == 'NO' ? 'selected' : '' }}>NO
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select name="recommendation" value="{{ old('recommendation') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="">-Choose-</option>
                                            @if (empty($data))
                                                <option disabled value="YES" {{ old('recommendation') == 'YES' ? 'selected' : '' }}>YES</option>
                                            <option disabled value="NO" {{ old('') == 'NO' ? 'selected' : '' }}>NO</option>
                                            @else
                                                <option disabled value="YES" {{ $data->recommendation == 'YES' ? 'selected' : '' }}>YES
                                                </option>
                                                <option disabled value="NO" {{ $data->recommendation == 'NO' ? 'selected' : '' }}>NO
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                        ...
                                        <select name="best_price" value="{{ old('best_price') }}" class="form-control select2" required>
                                            ...
                                            <option disabled value="">-Choose-</option>
                                            @if (empty($data))
                                                <option disabled value="YES" {{ old('best_price') == 'YES' ? 'selected' : '' }}>YES</option>
                                            <option disabled value="NO" {{ old('') == 'NO' ? 'selected' : '' }}>NO</option>
                                            @else
                                                <option disabled value="YES" {{ $data->best_price == 'YES' ? 'selected' : '' }}>YES
                                                </option>
                                                <option disabled value="NO" {{ $data->best_price == 'NO' ? 'selected' : '' }}>NO
                                                </option>
                                            @endif
                                        </select>
                                    ...
                                    <div class=" row mb-4">
                                    @if (empty($data))
                                  <label for="formFile" class="form-label mt-0">Image 1</label>
                                    ...
                                    <div class=" row mb-4">
                                        @if (empty($data))
                                      <label for="formFile" class="form-label mt-0">Image 2</label>
                                        ...
                                        <div class=" row mb-4">
                                            @if (empty($data))
                                          <label for="formFile" class="form-label mt-0">Image 3</label>
                                            ...
                                            <div class=" row mb-4">
                                                @if (empty($data))
                                              <label for="formFile" class="form-label mt-0">Image 4</label>
