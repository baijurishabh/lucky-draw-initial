    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header" >
                <h1 class="page-title">Dashboard P-Winners</h1>
                <div>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><a href="">Pending List</a></li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header" style="justify-content: space-between;">
                            <div>
                                <h3 class="card-title">Redeem Product and User Lists</h3>
                            </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{-- <a href="{{ route('admin.productEdit',$value->uuid) }}">
                                                   ...
                                                   @can('winner-delete')
                                                       <a href="{{ route('admin.winnerDelete',$value->uuid) }}" onclick="return confirm('Are you sure want to delete this proposal?')">
                                                        <button class="btn
                                                        btn-outline-danger
                                                        buttons-copy
                                                        buttons-html5"
