...
<div class="main-content app-content mt-0">
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <!-- ROW-1 OPEN -->
            @if (empty($referred_winne       <div class="row" id="user-profile">
                <div class="col-lg-12">
                    <div class="card" id="modal3">
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body text-center p-4 pb-5">
                                                ...
                                                <a href="{{route('admin.grandpoolList')}}"><button class="btn btn-success pd-x-25">Continue</button></a>
                            ...
                            <div class="text-center py-4 bg-light border">
                                <a class="btn btn-primary" href="{{route('admin.grandpoolList')}}">Back To Pool</a>
                            </div>
                            <!-- modal-footer-demo -->
                        </div>
                    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-body text-center p-4 pb-5">
                                                ...
                                                <i class="icon icon-check fs-70 text-success lh-1 my-4 d-inline-block"></i>
                                                <h4 class="text-success mb-4">Congratulations!</h4>
                                                <h6 class="text-success mb-4">{{$referred_winner->name}}</h6>
                                                <p class="mb-4 mx-4">Successfully Won {{$winner->product->name}}</p>
                                                <a href="{{route('admin.grandpoolList')}}"><button class="btn btn-success pd-x-25">Continue</button></a>
