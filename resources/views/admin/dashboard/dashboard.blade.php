    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header">
                <h1 class="page-title">{{Auth()->user()->roles->first()->name}} Dashboard</h1>
                <div>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12">
                    <div class="row">
                        ...
                        @endcan
                        @can('dashboard-total-payments')
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            <h6 class="">Total Payments</h6>
                                            <h2 class="mb-0 number-font">₹{{ number_format($payments->sum('amount')) }}
                                            </h2>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="chart-wrapper mt-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr class="border-bottom">
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <span class="avatar bradius"
                                                                                style="background-image: url('{{asset('storage/product/'.$order->product->image)}}')"></span>
                                                                    ...
                                                                    <td>  <div class="mt-sm-1 d-block">
                                                                        <span
                                                                            class="badge bg-success-transparent rounded-pill text-success p-2 px-3">{{$order->status}}</span>
                                                                    </div></td>
                                                                    <td><span
                                                                            class="fw-semibold mt-sm-2 d-block">₹ {{$order->product_price}}</span>
                                                                    </td>
                                                                    <td>
                                                                        <div class="d-flex">
                                                                            <div class="mt-0 mt-sm-3 d-block">
                                                                    ...
                                                                    <td>
                                                                        <div class="mt-sm-1 d-block">
                                                                            <span
                                                                                class="badge bg-success-transparent rounded-pill text-success p-2 px-3">{{$order->payment_status}}</span>
                                                                        </div>
                                                                    </td>
                                                                    {{-- <td>
                                                                        <div class="g-2">
                                                                            <a href="{{route('admin.orderEdit',$order->id)}}" class="btn text-primary btn-sm"
                                                                                data-bs-toggle="tooltip"
                                                                                data-bs-original-title="Edit"><span
                                                                                    class="fe fe-edit fs-14"></span></a>
                                                                            <a href="{{route('admin.orderDelete',$order->id)}}" class="btn text-danger btn-sm"
                                                                                data-bs-toggle="tooltip"
                                                ...
                                                <div class="tab-pane " id="tab4">
                                                    <div class="table-responsive">
                                                        <table id="data-table"
                                                            ...
                                                            <tbody>
                                                                @foreach ($orders->where('status','Dispatched') as $order)
                                                                <tr class="border-bottom">
                                                                    <td class="text-center">
                                                                        <div class="mt-0 mt-sm-2 d-block">
                                                                            <h6 class="mb-0 fs-14 fw-semibold">
                                                ...
                                                <div class="tab-pane " id="tab5">
                                                    <div class="table-responsive">
                                                        <table id="data-table"
                                                            ...
                                                            <tbody>
                                                                @foreach ($orders->where('status','Shipped') as $order)
                                                                <tr class="border-bottom">
                                                                    <td class="text-center">
                                                                        <div class="mt-0 mt-sm-2 d-block">
                                                                            <h6 class="mb-0 fs-14 fw-semibold">
                                                ...
                                                <div class="tab-pane " id="tab6">
                                                    <div class="table-responsive">
                                                        <table id="data-table"
                                                            ...
                                                            <tbody>
                                                                @foreach ($orders->where('status','Out for delivery') as $order)
                                                                <tr class="border-bottom">
                                                                    <td class="text-center">
                                                                        <div class="mt-0 mt-sm-2 d-block">
                                                                            <h6 class="mb-0 fs-14 fw-semibold">
