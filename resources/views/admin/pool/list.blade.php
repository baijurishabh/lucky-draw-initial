                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="{{ route('admin.poolList') }}">Pool</a></li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" style="justify-content: space-between;">
                                ...
                                @can('pool-create')
                                <div>
                                    <a href="{{ route('admin.poolCreate') }}"><button type="button"
                                        ...
                                        <tbody>
                                            @foreach ($data as $index => $value)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @can('pool-edit')
                                                        <a href="{{ route('admin.poolActiveList', $value->uuid) }}">
                                                            <input type="radio"
                                                                {{ $value->active == 'YES' ? 'checked' : '' }}
                                                    ...
                                                    btn-outline-success
                                                        ...
                                                        @can('pool-conduct')
                                                        @if ($value->active == 'YES')
                                                            <a href="{{ route('admin.luckyDrawSpinList', $value->uuid) }}">
                                                                <button
                                                                    class="btn
                                                        btn-outline-warning
                                                        buttons-copy
