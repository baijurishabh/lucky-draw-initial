    ...
    <div class="side-app">
        ...
        <div class="main-container container-fluid">
            ...
            <div class="page-header" >
                <h1 class="page-title">Lucky Draw Details</h1>
                <div>
                    <ol class="breadcrumb">
                                ...
                                <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('admin.grandluckyDrawSingleProductWinnerList',$value->uuid)}}">
                                                    <button class="btn
                                                    btn-outline-warning
                                                    buttons-copy
                                                    buttons-html5"
                                            ...
                                            <td>
                                                {{-- <a href="{{ route('admin.productEdit',$value->uuid) }}">
                                                   ...
                                                   <a href="{{route('admin.grandluckyDrawWinner',$value->id)}}" onclick="return confirm('Are you sure want to conduct the pool?')">
                                                    {{-- <button class="btn
                                                    btn-outline-primary
                                                    buttons-copy
                                                    buttons-html5 wrap"
                                                    tabindex="0"
                                                    aria-controls="datatable-buttons"
                                                    type="button"><span class="circle angled">Conduct Pool</span></button> --}}

                                                   <div class="wrap">
                                                    <button class="clicker">Spin</button>
