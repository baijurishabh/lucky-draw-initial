    ...
    <div class="signin">
      <div class="first_form col-6">
        <div class="sign_form">
          ...
          <p class="enter_deta">Please enter the details</p>
        ...
        @endif
        <input class="input"  name="password" autocomplete="new-password" type="password" placeholder="New Password" />
        @if ($errors->has('password'))
        <span class="help-block">
            <p style="color: red; font-size: .8rem; display: flex;">{{ $errors->first('password') }}</p>
        </span>
    @endif
    <input class="input"  name="password_confirmation" autocomplete="new-password" type="password" placeholder="Confirm Password" />
    @if ($errors->has('password_confirmation'))
    <span class="help-block">
        <p style="color: red; font-size: .8rem; display: flex;">{{ $errors->first('password_confirmation') }}</p>
    </span>
@endif
