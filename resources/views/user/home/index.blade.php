    ...
    <section class="container home">
        <div class="top ">
            <div class="my-auto">
                ...
                <h1 class="indexHeading">{{ __('messages.home_page.introduction.heading_1_1') }}</h1>
                <h1 class="indexHeading">{{ __('messages.home_page.introduction.heading_1_2') }}</h1>
                <h1 class="indexHeading">{{ __('messages.home_page.introduction.heading_1_3') }}</h1>
                <h1 class="indexHeading">{{ __('messages.home_page.introduction.heading_1_4') }}</h1>
              ...
              {{__('messages.home_page.introduction.paragraph_1')}}
                ...
                <a href="#products"> <button>
                        <span style="font-family: p4;">{{ __('messages.view_products') }}</span>
                        <span style="font-family: p4; color: #39b6fe;">{{ __('messages.view_products1') }}</span>
                    </button></a>
            </div>
        </div>
        <div class="bottom">
    ...
    @if ($products)
        <div class="carousel" id="products">
            ...
            @if ($products->count() % 2 == 0)
                <div class="card-carousel card-even">
                @else
                    <div class="card-carousel card-odd">
            @endif
                    ...
                    <div class=" item">
                        <div class="card" style=" background-color: #02010100">
                            ...
                            @if (Illuminate\Support\Facades\Storage::exists('public/product/' . $item->product->image))
                                <img class="card-img-top" style="width: 100% !important; height: 100% !important;"
                                    src="{{ asset('storage/product/' . $item->product->image) }}" alt="Card image cap">
                            @else
                                <img class="card-img-top" style="width: 100% !important; height: 100% !important;"
                                    src="{{ asset('frontend/assets/image/other/default.png') }}" alt="Card image cap" />
                            @endif
                            <div class="card-body">
                                {{-- <a
                                    href="{{ route('productView', ['slug' => $item->product->slug, 'pool_product_id' => $item->id]) }}"> --}}
                                    <h4 class="card-title">{{ Str::limit($item->product->name, 20) }}</h4>
                                    <p class="card-text" style="font-size: 1.9vw;     margin-bottom: 0rem;">Our Price: <span
                                            style="color: #39b6fe;">₹ {{ $item->product->our_price }}</span></p>
                                    <p class="card-text" style="font-size: 1.9vw;">M.R.P: ₹
                                        {{ $item->product->market_price }}</p>
                                    <div>
                                        {{-- <div class="row">
                          <div class="col-6">
                            <p class="card-text">Online Price: ₹ {{$item->product->online_price}}</p>
                          </div>
                          <div class="col-6">
                            <p class="card-text">Market Price: ₹ {{$item->product->market_price }}</p>  
                          </div>
                        </div> --}}
                                    </div>
                                    {{-- <div class="py-3">
...
<span class="fa fa-star star-checked"></span>
                                    ...
                                    <a href="{{ route('productView', ['slug' => $item->product->slug, 'pool_product_id' => $item->id]) }}"
                                        style="    background: #9B9B9B; */" class="btn btn-secondary">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="card text-black ">
                                            ...
                                            <div class="card-body my-0 py-0" style="height: 200px;">
                                                <div class="text-center">
                                                    <h5 class="card-title" style="font-family: p5;">
                                                        {{ Str::limit($product->product->name, 20) }}</h5>
                                                    <p class="text-muted mb-4" style="font-family: p5"> Price: ₹
    ...
    <section id="concept" class="how_it_works container">
        {{-- <button> --}}
        <div>
            <span style="font-family: p1; font-size: 2.5rem;">{{ __('messages.how_it_works1') }}</span>
            <span style="font-family: p1; font-size: 2.5rem; color: #39b6fe;">{{ __('messages.how_it_works') }}</span>
        </div>

        {{-- </button> --}}
        {{-- <h1 style="font-family: p4;">Watch this video to understand how we operate</h1> --}}
        <video class="pt-5" width="100%" controls poster="./frontend/assets/image/home/video_thumbnail.png">
    ...
    <section class="anyquery" id="anyquery">
