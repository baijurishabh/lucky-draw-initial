                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a
                                    href="{{ route('user.enquiryList') }}">Enquiry</a></li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                                ...
                                                <tr>
                                                    ...
                                                    type="button"><span>View</span></button>
                                                        ...
                                                        @if ($value->winner == 'YES')
                                                            <p>Pool Wined</p>
                                                        @else
                                                            @if ($value->pool->end_date >= Carbon\Carbon::now()->format('Y-m-d'))
                                                                <a href="{{ route('user.enquiryDelete', $value->uuid) }}"
                                                                    onclick="return confirm('Are you sure want to delete this enquiry?')">
                                                                    <button
                                                                        class="btn
                                                    btn-outline-danger
                                                    buttons-copy
