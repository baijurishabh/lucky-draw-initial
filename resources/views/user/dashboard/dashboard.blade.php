                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            ...
                                            <h2 class="mb-0 number-font">{{$user->order->count()}}</h2>
                                        </div>
                                        <div class="ms-auto">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            <h6 class="">Total Spends</h6>
                                            <h2 class="mb-0 number-font">₹{{number_format($user->payment->sum('amount'))}}</h2>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="chart-wrapper mt-1">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            <h6 class="">Total Enquiries</h6>
                                            <h2 class="mb-0 number-font">{{$user->enquiry->count()}}</h2>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="chart-wrapper mt-1">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xl-3">
                            <div class="card overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="mt-2">
                                            <h6 class="">Pool Wins</h6>
                                            <h2 class="mb-0 number-font">{{$user->winner->count()}}</h2>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="chart-wrapper mt-1">
                                                <canvas id="costchart"
