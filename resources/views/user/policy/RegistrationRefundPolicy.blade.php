                    ...
                    <div class="row faq-content">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 aboutUs-content-image">
                            <div class="pt-5 d-flex justify-content-center">
                                <button class="faq-content-btn2">Refund and Returnable Policy</button>
                            </div>
                            ...
                            <section>
                                <div class="accordion accordion-faq" id="accordionExample">
                                    ...
                                    @foreach (App\Models\Pages::all()->where('type','RegistrationPolicy') as $item)
                                    ...
                                    @foreach (App\Models\Pages::all()->where('type','ProductRefundPolicy') as $item)
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="headingOne">
                                            <button class="accordion-button">
                                                <b style="font-family: p5">{{$item->heading}}</b>
