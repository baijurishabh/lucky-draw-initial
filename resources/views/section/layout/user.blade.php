...
<head>
    ...
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('storage/settings/'.$setting->favicon) }}" />
@include('section.user.head')
    <!-- TITLE -->
...
<body class="app sidebar-mini ltr light-mode">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!-- app-Header -->
@include('section.user.header')
            <!-- /app-Header -->
@include('section.user.sidebar')
            <!--APP-SIDEBAR-->
        ...
        <!-- Sidebar-right -->
@include('section.user.sidebarright')
        <!--/Sidebar-right-->
