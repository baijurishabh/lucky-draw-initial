                        ...
                        <div class="d-flex order-lg-2">
                                    ...
                                    <div class="notifications-menu">
                                        <a class="dropdown-item d-flex" href="">
                                            ...
                                            <div class="mt-1 wd-80p">
                                                <h5 class="notification-label mb-1">Welcome to our application
                                                </h5>
                                                <span class="notification-subtext">Today</span>
                                            </div>
                                        </a>
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                    <img src="{{asset('storage/user/'.Auth()->user()->userDetails->image)}}" alt="profile-user"
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <a class="dropdown-item" href="{{Auth()->user()->getReferralLink() }}">
                                        <i class="dropdown-icon fe fe-layers"></i> Referral Link
                                    </a>
